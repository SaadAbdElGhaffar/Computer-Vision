"""
HOG (Histogram of Oriented Gradients) Example
the size of the image is 64x128 if the image is not 64x128 it will be downsampled with image pyramids.
"""
...
filename = 'data/pedestrians1.png'
...
def main():
    ...
    # i want classify to differentiate between people and other objects
    # The HOGDescriptor_getDefaultPeopleDetector() method provides a pre-trained model for pedestrian detection
    ...
    cv2.imwrite('output/'+ new_filename, image)
